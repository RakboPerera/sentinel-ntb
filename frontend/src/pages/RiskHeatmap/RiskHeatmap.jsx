        ...
        <div style={{ padding:'20px 24px', background:c.bg, borderBottom:'1px solid var(--color-border)', flexShrink:0 }}>
          ...
          {(branch.aml_flag||branch.cbsl_flag||branch.sla_breach) && (
            <div style={{ display:'flex', gap:6, marginTop:10, flexWrap:'wrap' }}>
              ...
              {branch.sla_breach && <span style={{ fontSize:10, fontWeight:700, padding:'3px 8px', background:'#FFFBEB', color:'#854F0B', borderRadius:5, border:'1px solid #FDE68A' }}>⏱ SLA Breach</span>}
            </div>
          )}
        </div>
