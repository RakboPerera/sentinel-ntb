...
const TIERS = [
  {
    ...
    color: '#534AB7',
    agents: [
      { id: 'transaction', name: 'Transaction Surveillance', color: '#534AB7' },
      { id: 'digital',     name: 'Digital Fraud & Identity', color: '#993556' },
      { id: 'mje',         name: 'MJE Testing',              color: '#0891B2' },
    ],
  },
  {
    level: 2,
  ...
  },
  {
    ...
    agents: [
      ...
      { id: 'controls', name: 'Internal Controls',     color: '#854F0B' },
      { id: 'insider',  name: 'Insider Risk',          color: '#7C3AED' },
    ],
  },
];
...
const ALL_AGENTS = [
  ...
  { id: 'orchestrator', name: 'Orchestrator', color: '#534AB7' },
];
      ...
      {showTiers && (
        <div className="animate-fade-in" style={{ margin: '24px 0 32px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center', padding: '14px 20px', background: 'rgba(83,74,183,0.06)', border: '1px solid rgba(83,74,183,0.25)', borderRadius: 12 }}>
            <div style={{ flexShrink: 0, textAlign: 'center', width: 44 }}>
              <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#534AB7', opacity: 0.7 }}>L4</div>
              <div style={{ fontSize: 20, fontWeight: 900, color: '#534AB7', lineHeight: 1 }}>◎</div>
            </div>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#534AB7', marginBottom: 2 }}>Synthesis Layer — Orchestrator</div>
            ...
            <span style={{ fontSize: 10, fontWeight: 600, padding: '3px 10px', background: 'rgba(83,74,183,0.18)', color: '#534AB7', border: '1px solid rgba(83,74,183,0.33)', borderRadius: 20 }}>Orchestrator</span>
          </div>
        </div>
      )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          ...
          <div style={{ marginTop: 6, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ padding: '8px 14px', borderRadius: 8, background: activeAgentSet.has('Orchestrator') ? 'rgba(83,74,183,0.18)' : 'rgba(255,255,255,0.03)', border: `1px solid ${activeAgentSet.has('Orchestrator') ? 'rgba(83,74,183,0.5)' : 'rgba(255,255,255,0.07)'}`, color: activeAgentSet.has('Orchestrator') ? '#f4f2ec' : 'rgba(232,230,224,0.5)', fontSize: 12, fontWeight: activeAgentSet.has('Orchestrator') ? 600 : 400, display: 'flex', alignItems: 'center', gap: 8 }}>
              <div style={{ width: 7, height: 7, borderRadius: '50%', background: activeAgentSet.has('Orchestrator') ? '#534AB7' : 'rgba(255,255,255,0.1)', flexShrink: 0 }} />
              Orchestrator
              {activeAgentSet.has('Orchestrator') && <span style={{ marginLeft: 'auto', fontSize: 10, color: '#534AB7' }}>correlates</span>}
            </div>
          </div>
        </div>
      </div>
