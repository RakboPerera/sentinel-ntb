...
const SEVERITY_CONFIG = {
  critical: { bg: '#FEF0F0', border: '#FECACA', badge: '#C41E3A', icon: '🔴', label: 'CRITICAL', textColor: '#8B0F23' },
  high:     { bg: '#F3F3F1', border: '#D1D0CB', badge: '#4A6070', icon: '🟡', label: 'HIGH',     textColor: 'var(--color-text-2)' },
